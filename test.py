...
# Set the tracking URI for DagsHub using environment variables
os.environ['MLFLOW_TRACKING_URI'] = 'https://dagshub.com/masterwithhamza/Mlflow-project.mlflow'
os.environ['MLFLOW_TRACKING_USERNAME'] = 'masterwithhamza'  # Replace with your DagsHub username
os.environ['MLFLOW_TRACKING_PASSWORD'] = '23212b0f18741aac0f6c659e80bbef612521ad23'  # Your DagsHub token

def train_and_log_model(max_iter):
    # Initialize DagsHub for MLflow tracking
    with dagshub_logger() as logger:
        logger.log_hyperparams({
            'repo_owner': 'masterwithhamza',
